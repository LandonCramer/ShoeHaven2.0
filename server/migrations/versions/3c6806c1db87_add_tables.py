...
Revision ID: 3c6806c1db87
Revises: 
Create Date: 2023-12-23 14:50:08.554358
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('user_id', 'sneakerid')
    )
    op.create_table('cart_sneakers',
    sa.Column('id', sa.Integer(), nullable=False),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('cart_sneakers')
    op.drop_table('user_sneakers')
    op.drop_table('carts')
    op.drop_table('users')
